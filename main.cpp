...
int thread_id = 0 ; //pongo una variable global de thread ID, para poder identificar los diferentes productores/consumidores en los test de mas de un productor o consumidor.
